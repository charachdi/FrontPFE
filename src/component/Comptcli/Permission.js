    ...
    return (
        ...
        {/* {
            ...
            <thead>
                    ...
                    Auths.map((auth , index)=>(
                                <tr key={index}>
                                <td className=""> <div className="row justify-content-center"><Avatar className="ml-4" src={ auth.User ? auth.User.user_img : ""} alt={auth.User ? auth.User.full_name : ""} style={{width:40, height:40}}/>  <p className="my-auto mx-auto">{auth.User ? auth.User.full_name : ""}</p></div></td>
                                <td>
                                <Switch
                                    size="small"
                                    checked={auth.Permission.Read === "true" ? true : false}
